...
func TestGatewayDevelopsPlainDirectoryWithoutGit(t *testing.T) {
	...
	for _, required := range []string{"workspace_list", "workspace_add", "workspace_inspect", "workspace_rename", "workspace_remove", "exec_allow", "exec_allow_remove", "environment_create", "environment_rename", "environment_remove", "environment_writer_acquire", "environment_writer_heartbeat", "environment_verifier_list", "environment_verifier_run", "mcp_list", "mcp_add", "mcp_update", "mcp_import_preview", "mcp_import_apply", "environment_mcp_set", "environment_mcp_inspect", "environment_mcp_refresh", "environment_mcp_tools", "environment_mcp_call", "skill_list", "skill_add", "skill_source_list", "skill_source_add", "skill_source_refresh", "skill_source_remove", "environment_skill_set", "environment_skill_list", "environment_skill_read", "memory_global_write", "memory_environment_write", "tree", "read", "search", "write", "edit", "delete", "exec", "git_status"} {
